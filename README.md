...
- ⚡ **AI categoriser** — Groq tags every expense in under 500ms
- 💬 **Chat with your finances** — ask anything, answered from your actual data
- 🎯 **Can I afford this?** — Gemini checks your budget, goals, and bills before answering
...
AI        →  Groq llama-3.1-8b · Gemini 1.5 Flash
```
